...
def hero():
    ...
    while(y):
        ...
        print("Contact me on telegram @Rxcehackingk'')
...
if(expirydate>today):
    ...
    print(" on telegram ---- Rxcehackingk for activating")
    ...
    while(True):
        ...
        print("send payment only to Rubiakosser'')

        print("payhere--- UPI : ")

        print("UPI1 :8082646042@paytm")
        ...
        if(bhai==code):
            ...
            #sys.exit(" \n \n \n Contact on Telegram Rxcehackingk'')
